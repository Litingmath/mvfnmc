...
class NRLMF:
    ...
    def __init__(self, lambda_d=0.625, lambda_t=0.625, gamma_1=1.1, alpha=0.1, max_iter=100):
    ...
    def __str__(self):
        return "Model: MvFNMC,  lambda_d:%s, lambda_t:%s, gamma_1:%s, alpha:%s, max_iter:%s" % (self.lambda_d, self.lambda_t, self.gamma_1, self.alpha, self.max_iter)
