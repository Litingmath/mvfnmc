...
class MKTCMF:
    ...
    def __init__(self, lamda1=1, lamda2=1, lamda_T=1,lamda_L=1, lamda_w=1, max_iter=2, k1=200,k2=200,pre=1):
        self.lamda1 = float(lamda1)
        self.lamda2 = float(lamda2)
        self.lamda_T = float(lamda_T)
        self.lamda_L = float(lamda_L)
        self.lamda_w = float(lamda_w)
    ...
    def optimization(self,test_idx,W1,W2,L1,L2,y):
